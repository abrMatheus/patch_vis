...
# datasets = ['refuge', 'refuge_rgb', 'refuge_match', 'refuge_new_match']
...
for n_svox in [25]:
    ...
    for k_size in [3]:
        ...
        for i, dataset in enumerate(datasets):
            ...
            patch_dir = f"s_patches_rgb/{dataset}/s_{split}/n_{n_svox}/k_{k_size}"
        ...
        fig.savefig(f"result2/rgb_nnp_appa_sv={n_svox}_k={k_size}_split={split}.png")
